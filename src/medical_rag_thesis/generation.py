...
def build_chat_prompt(tokenizer: Any, system_prompt: str, user_prompt: str, language: str = "es") -> str:
    messages = [
...
def make_prompt(
    ...
    *,
    ...
    return build_chat_prompt(tokenizer, resolved_prompt, user_prompt, language=language)
