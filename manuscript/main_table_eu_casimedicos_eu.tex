...
\caption[Basque CasiMédicos-Arg dev ablation]{Basque CasiMedicos EU dev ablation (55 examples, multiple-choice). Same metrics as \autoref{tab:es-main-sns}.} \label{tab:eu-main-casi} \\
\toprule
