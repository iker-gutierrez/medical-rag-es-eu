#!/bin/bash
#SBATCH --job-name=medrag-extractive-eval
#SBATCH --cpus-per-task=8
#SBATCH --nodes=1
#SBATCH --ntasks-per-node=1
#SBATCH --time=06:00:00
#SBATCH --mem=48GB
#SBATCH --output=/home/igutierrez134/med_rag_thesis/experiments/slurm_logs/dev_extractive_evaluation_%j.log
#SBATCH --error=/home/igutierrez134/med_rag_thesis/experiments/slurm_logs/dev_extractive_evaluation_%j.err
...
echo "Extractive evaluation started on $(hostname)"
echo "Date: $(date)"
echo "SLURM_JOB_ID=${SLURM_JOB_ID:-}"

for run_id in \
  17_mistral7b_no_rag_no_think_extractive_sf_dev \
  18_mistral7b_rag_no_think_extractive_sf_dev \
  19_mistral7b_rag_no_think_e5_topk3_extractive_sf_dev \
  20_mistral7b_random_3shot_no_rag_no_think_extractive_sf_dev \
  21_mistral7b_retrieval_3shot_no_rag_no_think_extractive_sf_dev
do
...
echo "Extractive evaluation finished at $(date)"
