#!/bin/bash
#SBATCH --job-name=medrag-v1-rerank-eval
#SBATCH --cpus-per-task=8
#SBATCH --nodes=1
#SBATCH --ntasks-per-node=1
#SBATCH --time=06:00:00
#SBATCH --mem=48GB
#SBATCH --output=/home/igutierrez134/med_rag_thesis/experiments/slurm_logs/dev_v1_rerank_evaluation_%j.log
#SBATCH --error=/home/igutierrez134/med_rag_thesis/experiments/slurm_logs/dev_v1_rerank_evaluation_%j.err
...
echo "v1 rerank evaluation started on $(hostname)"
echo "Date: $(date)"
echo "SLURM_JOB_ID=${SLURM_JOB_ID:-}"

for run_id in \
  22_mistral7b_rag_no_think_e5_rerank3_v1_extractive_sf_dev \
  23_mistral7b_rag_no_think_minilm_rerank3_v1_extractive_sf_dev
do
...
echo "v1 rerank evaluation finished at $(date)"
