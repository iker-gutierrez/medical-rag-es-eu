#!/bin/bash
#SBATCH --job-name=medrag-chain-b
...
#SBATCH --gres=gpu:1
#SBATCH --array=0-4%1
#SBATCH --output=/home/igutierrez134/med_rag_thesis/experiments/slurm_logs/chain_b_%A_%a.log
#SBATCH --error=/home/igutierrez134/med_rag_thesis/experiments/slurm_logs/chain_b_%A_%a.err
