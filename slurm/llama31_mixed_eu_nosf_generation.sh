...
#SBATCH --mem=64GB
#SBATCH --gres=gpu:1
#SBATCH --output=/home/igutierrez134/med_rag_thesis/experiments/slurm_logs/llama31_mixed_eu_nosf_generation_%A_%a.log
#SBATCH --error=/home/igutierrez134/med_rag_thesis/experiments/slurm_logs/llama31_mixed_eu_nosf_generation_%A_%a.err
...
echo "Job llama-eu-nosf started on $(hostname)"
echo "Date: $(date)"
...
echo "Job llama-eu-nosf finished at $(date)"
