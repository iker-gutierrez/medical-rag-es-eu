...
#SBATCH --mem=64GB
#SBATCH --gres=gpu:1
#SBATCH --output=/home/igutierrez134/med_rag_thesis/experiments/slurm_logs/mistral_mixed_sf_generation_%A_%a.log
#SBATCH --error=/home/igutierrez134/med_rag_thesis/experiments/slurm_logs/mistral_mixed_sf_generation_%A_%a.err
...
echo "Job mistral-sf started on $(hostname)"
echo "Date: $(date)"
...
echo "Job mistral-sf finished at $(date)"
