#!/bin/bash
#SBATCH --job-name=medrag-baseline-sf-eval
#SBATCH --cpus-per-task=8
#SBATCH --nodes=1
#SBATCH --ntasks-per-node=1
#SBATCH --time=06:00:00
#SBATCH --mem=48GB
#SBATCH --output=/home/igutierrez134/med_rag_thesis/experiments/slurm_logs/dev_baseline_sf_evaluation_%j.log
#SBATCH --error=/home/igutierrez134/med_rag_thesis/experiments/slurm_logs/dev_baseline_sf_evaluation_%j.err
...
echo "Baseline self-feedback evaluation started on $(hostname)"
echo "Date: $(date)"
...
echo "Baseline self-feedback evaluation finished at $(date)"
