...
#SBATCH --gres=gpu:1
#SBATCH --array=0-10%1
#SBATCH --output=/home/igutierrez134/med_rag_thesis/experiments/slurm_logs/mixed_eu_%A_task%a_%x.log
#SBATCH --error=/home/igutierrez134/med_rag_thesis/experiments/slurm_logs/mixed_eu_%A_task%a_%x.err
