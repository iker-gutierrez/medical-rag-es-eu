#!/bin/bash
#SBATCH --job-name=eval-qwen-think
...
#SBATCH --mem=48GB
#SBATCH --gres=gpu:1
#SBATCH --output=/home/igutierrez134/med_rag_thesis/experiments/slurm_logs/eval_qwen35_9b_es_think_%j.log
#SBATCH --error=/home/igutierrez134/med_rag_thesis/experiments/slurm_logs/eval_qwen35_9b_es_think_%j.err
...
echo "eval-qwen-think started on $(hostname) at $(date)"
nvidia-smi || true
...
echo "eval-qwen-think finished at $(date)"
