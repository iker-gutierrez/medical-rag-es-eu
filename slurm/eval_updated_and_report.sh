#!/bin/bash
#SBATCH --job-name=eval-updated-report
...
echo "eval-updated-report started on $(hostname) at $(date)"
nvidia-smi || true

echo ""
echo "=== Evaluating updated mixed-dev runs (auto-splits by source: overall/sns1064/casimedicos) ==="
python - <<'PYEOF'
import subprocess
import sys
...
echo ""
echo "eval-updated-report finished at $(date)"
